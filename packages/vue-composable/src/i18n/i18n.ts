...
import { FormatObject, FormatValue, useFormat, usePath } from "../format";
 ...
 */
export type i18nMessage<T> = T extends Ref<string> ? string
  : T extends () => Promise<infer P> ? i18nLocale<P>
  : T extends (...args: infer TArgs) => RefTyped<string>
    ? (...args: TArgs) => string
  : T extends object ? i18nLocale<T>
