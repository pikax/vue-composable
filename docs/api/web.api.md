...
export function useBroadcastChannel<T = any>(name: string, onBeforeClose?: Function): {
    supported: boolean;
    data: import("@vue/reactivity").Ref<T | null>;
    messageEvent: import("@vue/reactivity").Ref<MessageEvent | null>;
    errorEvent: import("@vue/reactivity").Ref<MessageEvent | null>;
    errored: import("@vue/reactivity").Ref<boolean>;
    isClosed: import("@vue/reactivity").Ref<boolean>;
    send: (data: T) => void;
    close: Function;
...
export function useFetch<T = any>(options?: UseFetchOptions & Partial<RequestInfo>, requestInit?: RequestInit): {
    ...
    statusText: import("@vue/reactivity").ComputedRef<string | null>;
    exec: (request: RequestInfo, init?: RequestInit | undefined) => Promise<Response | undefined>;
    promise: import("@vue/reactivity").Ref<Promise<Response> | undefined>;
    result: import("@vue/reactivity").Ref<Response | null>;
...
export function useGeolocation(options?: PositionOptions & GeolocationOptions): {
    supported: boolean;
    refresh: () => void;
    error: import("@vue/reactivity").Ref<PositionError | null>;
    timestamp: import("@vue/reactivity").Ref<number | null>;
    coords: import("@vue/reactivity").Ref<Coordinates | null>;
    highAccuracy: import("@vue/reactivity").Ref<boolean | null>;
};
...
export function useWebSocket(url: string, protocols?: string | string[]): {
    ...
    messageEvent: import("@vue/reactivity").Ref<MessageEvent>;
    errorEvent: import("@vue/reactivity").Ref<Event>;
    data: any;
    isOpen: import("@vue/reactivity").Ref<boolean>;
    isClosed: import("@vue/reactivity").Ref<boolean>;
    errored: import("@vue/reactivity").Ref<boolean>;
};
