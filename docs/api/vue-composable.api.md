...
// @public (undocumented)
export function useLocalStorage<T>(key: string, defaultValue?: RefTyped<T>, sync?: boolean): LocalStorageReturn<T>;
...
// @public (undocumented)
export function useSessionStorage<T>(key: string, defaultValue?: RefTyped<T>, sync?: boolean): LocalStorageReturn<T>;
