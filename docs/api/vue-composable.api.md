...
export function refShared<T = any>(
  ...
  | Ref_2<undefined>
  | (T extends Ref_2<any> ? T : Ref_2<import("vue3").UnwrapRef<T>>)
  | Ref_2<RefTyped<T>>;
...
export function useSharedRef<T = any>(
  ...
  id: number;
  data: Ref_2<T>;
  master: Ref_2<false> | Ref_2<true>;
  mind: Ref_2<SharedRefMind.HIVE> | Ref_2<SharedRefMind.MASTER>;
  editable: import("vue3").ComputedRef<boolean>;
  targets: Ref_2<number[]>;
  ping: () => void;
